...
int CDECL main(int argc, char **argv)
{
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    printf("withdll.exe: Warning - The process will be restarted:\"%s\"\n", szExe);
    const std::string fullpath = std::string(szExe);
    const std::string filename = fullpath.substr(fullpath.find_last_of("/\\") + 1);
    HANDLE openedExplorer = GetProcessByName(std::wstring(filename.begin(), filename.end()).c_str());
    if (openedExplorer == NULL)
    {
        return 1;
    }
    TerminateProcess(openedExplorer, 1);
    CloseHandle(openedExplorer);
    /////////////////////////////////////////////////////////////////////////////////////////////////////////
